...
<head>
    ...
    <title>Reset Password - CyberShield.lk</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        .gradient-bg { background: linear-gradient(135deg, #1e3a8a 0%, #7c3aed 100%); }
        .glass-effect { background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); }
        .input-focus:focus { border-color: #7c3aed; box-shadow: 0 0 0 3px rgba(124, 58, 237, 0.2); transform: translateY(-2px); }
        ...
        .password-strength { height: 4px; border-radius: 2px; transition: all 0.3s ease; width: 0%; }
    </style>
</head>
<body class="min-h-screen gradient-bg flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="glass-effect rounded-3xl shadow-2xl p-8 w-full max-w-md relative z-10">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 text-sm">🔐 Set a new password</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-3">
                <label class="block text-gray-700 font-medium mb-2">
                    <i class="fas fa-lock text-purple-600 mr-2"></i>New Password
                </label>
        ...
        <p class="text-center text-gray-500 text-sm mt-4">
            <a href="{{ route('login') }}" class="text-purple-600 hover:text-purple-800 hover:underline">
